 ...
 * - Two token types:
 *     DA_WRITE_TOKEN       → Required for all write and admin operations (create, update, delete, etc.)
 ...
 *     DA_WRITE_TOKEN=your-write-token
...
function authenticateRequest(request, env) {
  ...
  const WRITE_TOKEN = env.DA_WRITE_TOKEN;
  const READ_ONLY_TOKEN = env.DA_READ_ONLY_TOKEN;
